...
// Metro requires a static CommonJS asset reference here; the resolved module is a numeric asset ID.
// eslint-disable-next-line @typescript-eslint/no-require-imports -- React Native Metro asset contract
const CAPTURE_HTML = require('../../assets/capture-native.html') as number;
